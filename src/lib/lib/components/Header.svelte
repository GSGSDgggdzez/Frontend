...
<header class="z-99 fixed left-0 right-0 top-0 bg-white">
	<div
		class="navbar border-b-1 shadow-[0px_3.2px_3.2px_0px_rgba(0,0,0,0.10) h-18 w-full justify-between border-[#EAEAEA] px-[25px] sm:h-24"
	>
		<div class="flex-auto">
		...
		<div class="flex md:hidden">
			<button
				class="btn btn-primary btn-lg btn-ghost rounded-xl px-1 py-1"
